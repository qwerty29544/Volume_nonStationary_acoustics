...
def ThreeSGD_solver(complex_matrix: np.ndarray,
    ...
    for iter_index in range(3, n_iter):
        ...
        a_2 = utils.matrix_diag_prod(complex_matrix, g[iter_index - 1])
        ...
        l_13 = -utils.vec_dot_complex_prod(g[iter_index - 1], g[iter_index - 1])
        l_21 = l_12 * 1
        l_22 = utils.vec_dot_complex_prod(a_1, a_1)
        l_23 = utils.vec_dot_complex_prod(a_2, a_1)
        l_31 = -utils.vec_dot_complex_prod(a_2, a_2)
        ...
        new_u = u_vector[iter_index - 1] - \
                ...
                gamma[iter_index] * g[iter_index - 1]
