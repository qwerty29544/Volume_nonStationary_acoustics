...
def ThreeSGD_solver(complex_matrix: np.ndarray,
    ...
    if difference < eps:
        return u_vector, it_space, r, delta_r, g, alpha, beta, gamma
    ...
    for iter_index in range(3, n_iter):
        ...
        a_2 = utils.matrix_diag_prod(complex_matrix, r[iter_index])
        ...
        l_13 = utils.vec_dot_complex_prod(a_2, delta_r[iter_index])
        l_21 = l_12 * 1
        l_22 = utils.vec_dot_complex_prod(a_1, a_1)
        l_23 = utils.vec_dot_complex_prod(a_2, a_1)
        l_31 = utils.vec_dot_complex_prod(delta_r[iter_index], a_2)
        l_32 = utils.vec_dot_complex_prod(a_1, a_2)
        l_33 = utils.vec_dot_complex_prod(a_2, a_2)
        c_1 = 0
        c_2 = l_21 * 1
        c_3 = utils.vec_dot_complex_prod(r[iter_index], a_2)

        det_L = l_11 * l_22 * l_33 + l_12 * l_23 * l_31 + l_13 * l_21 * l_32 - \
                l_13 * l_22 * l_31 - l_12 * l_21 * l_33 - l_11 * l_23 * l_32
        det_L1 = c_1 * l_22 * l_33 + l_12 * l_23 * c_3 + l_13 * c_2 * l_32 - \
                l_13 * l_22 * c_3 - l_12 * c_2 * l_33 - c_1 * l_23 * l_32
        det_L2 = l_11 * c_2 * l_33 + c_1 * l_23 * l_31 + l_13 * l_21 * c_3 - \
                l_13 * c_2 * l_31 - c_1 * l_21 * l_33 - l_11 * l_23 * c_3
        det_L3 = l_11 * l_22 * c_3 + l_12 * c_2 * l_31 + c_1 * l_21 * l_32 - \
                c_1 * l_22 * l_31 - l_12 * l_21 * c_3 - l_11 * c_2 * l_32
...
def _main():
    ...
    solve, it_space, _, _, _, alpha, beta, gamma = ThreeSGD_solver(A_matrix, f_vector)
